...
description: P Foundation is redoubling its efforts through the MediaGuard program, which has been steadfastly supporting journalists and media organizations for the past 18 months, all at no cost.
...
Given the recent escalation in Gaza, we perceive an escalating risk of military conflict between Israel and Lebanon.
...
While most TV broadcasters in Lebanon use IP for their backhaul, we believe they all also maintain a satellite backup. We urge all broadcasters to ensure that their satellite backup is operational.
...
Our infrastructure includes Zixi encoders in both locations and we maintain an open channel with Arabsat NOC, enabling broadcasters to switch to a backup within minutes of any outage.
...
For those experiencing growing viewership on their proprietary platforms and unable to switch to others, we've partnered with multiple CDNs and we are able to increase the free content distribution limit from 100TB a month to 1PB.
...
In addition, we have increased our capacity in DC, and we are able to accommodate most media platforms. If you think that you are likely to be targeted and you prefer to move your website to our isolated infrastructure, please reach out to your contact points at PF and we will help you with the migration.
