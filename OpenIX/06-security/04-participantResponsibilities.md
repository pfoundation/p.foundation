...
- Use strong authentication for any remote management of your equipment. You should assume the exchange (like any network) could be scanned or targeted; secure your router’s login, use encryption (SSH instead of Telnet, etc.), and if possible, limit management access to your router through your own network (and not via the peering interface).
