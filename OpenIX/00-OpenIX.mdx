...
[OpenCache](/products/opencache), the P Foundation's open caching network, is live at the exchange, so peering networks reach cached content over local peering.
