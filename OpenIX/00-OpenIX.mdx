...
import IxStats from '@site/src/components/oix/IxStats';
...
[OpenCache](/products/opencache), the P Foundation's open caching network, is live at the exchange, allowing peering networks to reach cached content over local peering.
