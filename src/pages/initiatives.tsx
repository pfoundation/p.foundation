...
const projects: ProjectData[] = [
  {
    ...
    image: require(`${assetsDir}/lebanonAlerts.png`),
    role: "Active",
    x: "LebanonAlerts",
  ...
  },
  {
    ...
    image: require(`${assetsDir}/iam.png`),
    role: "Active",
    x: "LebanonIAMonitor",
  },
  {
    ...
    description: ``,
    url: "https:///",
    image: require(`${assetsDir}/ptun.png`),
    role: "Active",
  },
  {
    title: "Open Reporting",
    description: ``,
    image: require(`${assetsDir}/or.png`),
    role: "Queued",
  },
  {
    title: "National Digital Archive",
    description: ``,
    image: require(`${assetsDir}/nda.png`),
    role: "Queued",
  },
];
